...
namespace detail
{
	...
	GLM_FUNC_QUALIFIER u8vec2 bitfieldDeinterleave(glm::uint16 x)
	{
		...
		REG1 = static_cast<uint16>((REG1 >> 1) | REG1) & static_cast<uint16>(0x3333);
		REG2 = static_cast<uint16>((REG2 >> 1) | REG2) & static_cast<uint16>(0x3333);

		REG1 = static_cast<uint16>((REG1 >> 2) | REG1) & static_cast<uint16>(0x0F0F);
		REG2 = static_cast<uint16>((REG2 >> 2) | REG2) & static_cast<uint16>(0x0F0F);

		REG1 = static_cast<uint16>((REG1 >> 4) | REG1) & static_cast<uint16>(0x00FF);
		REG2 = static_cast<uint16>((REG2 >> 4) | REG2) & static_cast<uint16>(0x00FF);

		REG1 = static_cast<uint16>((REG1 >> 8) | REG1) & static_cast<uint16>(0xFFFF);
		REG2 = static_cast<uint16>((REG2 >> 8) | REG2) & static_cast<uint16>(0xFFFF);
