...
struct QueuesPlanner {
	rn::vki::HandleSurfaceKHR surface{};
	...
	QueuesPlanner(rn::vki::HandleSurfaceKHR &&surface, rn::vki::HandlePhysicalDevice &&physicalDevice, std::vector<vk::QueueFamilyProperties2> &&familyProperties) noexcept;
