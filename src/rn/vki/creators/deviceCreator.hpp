...
public:
	...
	[[nodiscard]] std::pair<std::vector<std::vector<float>>, std::vector<vk::DeviceQueueCreateInfo>> buildDeviceQueueCreateInfos(const vk::SurfaceKHR &surface, const vk::PhysicalDevice &physicalDevice);
